...
export function RoleBasedRoute({ 
  ...
  const hasRequiredRole = Boolean(userRole && requiredRoles.includes(userRole));
  ...
  useEffect(() => {
    if (!loading && !roleLoading && user && !hasRequiredRole && !showAccessDenied) {
      setLocation(unauthorizedFallbackPath);
    }
  }, [hasRequiredRole, showAccessDenied, user, loading, roleLoading, setLocation, unauthorizedFallbackPath]);
