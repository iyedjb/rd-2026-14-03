...
export function SimpleTravelApp() {
  ...
  const filteredClients = clients.filter(client =>
    `${safeText(client.first_name)} ${safeText(client.last_name)}`.toLowerCase().includes(normalizedSearchTerm) ||
    safeText(client.destination).toLowerCase().includes(normalizedSearchTerm) ||
    safeText(client.cpf).toLowerCase().includes(normalizedSearchTerm) ||
    safeText(client.email).toLowerCase().includes(normalizedSearchTerm) ||
    safeText(client.phone).toLowerCase().includes(normalizedSearchTerm)
  );
